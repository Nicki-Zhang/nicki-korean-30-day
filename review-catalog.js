(function (global) {
  ...
  define('lesson01:shadowing', { lessonId: 'lesson-01', kind: 'listen', cue: '가 · 나', audio: '가, 나', options: ['가 · 나', '나 · 가', '거 · 너', '고 · 노'], answer: 0 });
  ...
  define('lesson02:shadowing', { lessonId: 'lesson-02', kind: 'listen', cue: '나무 · 다리 · 머리', audio: '나무, 다리, 머리', options: ['나무 · 다리 · 머리', '다리 · 나무 · 머리', '머리 · 나무 · 다리', '나무 · 머리 · 다리'], answer: 0 });
  ...
  define('lesson04:batchim', { lessonId: 'lesson-04', kind: 'listen', cue: '받침', audio: '앙', options: ['안', '앙', '암', '알'], answer: 1 });
  define('lesson04:thanks', { lessonId: 'lesson-04', kind: 'listen', cue: '감사합니다', audio: '감사합니다', options: ['감사합니다', '안녕하세요', '안녕', '바다'], answer: 0 });
  define('lesson04:quiz:0', { lessonId: 'lesson-04', kind: 'listen', audio: '만', options: ['마', '만', '망', '맘'], answer: 1 });
  define('lesson04:quiz:1', { lessonId: 'lesson-04', kind: 'build', cue: 'ㅂ + ㅏ + ㅁ', options: ['반', '밤', '방', '발'], answer: 1 });
  define('lesson04:quiz:2', { lessonId: 'lesson-04', kind: 'listen', audio: '한국', options: ['한국', '안녕', '사람', '바다'], answer: 0 });
