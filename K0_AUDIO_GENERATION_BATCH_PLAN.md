...
严格允许列表：`ga/가/ga.mp3`、`ka/카/ka.mp3`、`kka/까/kka.mp3`，共3条。三条均为 `initial-example`，正式manifest保持 `pending/missing`。用途是先确认已批准的 marin 女声能否自然区分普通音、送气音和紧音。

## Batch 2B（仅规划，禁止触发）

剩余13条：다、타、따、바、파、빠、자、차、짜、사、싸、하、그。只有Batch 2A经产品负责人课程内试听通过后才可进一步授权；其中 하、그 还必须先补齐准确的正式catalog/manifest记录。
