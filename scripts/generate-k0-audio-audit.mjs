...
fs.writeFileSync('K0_AUDIO_FILE_TECHNICAL_AUDIT.md',`# K0 音频文件技术审计\n\n${summary}\n现有46个活动文件只通过“存在/可读取”层检查，仍为 legacy-unreviewed/pending；16个 Apple 导出明确标记 legacy-system-export。技术可解码不等于发音批准。2个 deprecated 文件保留但统一门禁和 Service Worker 均禁止使用。\n`);
...
fs.writeFileSync('K0_AUDIO_RIGHTS_AND_REVIEW_GAPS.md',`# K0 音频权利与审核缺口\n\n${summary}\n所有75条均缺正式母语审核或完整发布记录，因此 approved=0。未知日期、审核人和许可信息保持 null / pending-documentation，不作推断。16条 legacy-system-export 后续应重新制作并记录合法商业使用依据。\n`);
