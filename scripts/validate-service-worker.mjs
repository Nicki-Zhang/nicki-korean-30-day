...
assert.match(cacheName, /reviewed-existing-audio-approved/, 'Cache version must identify the approved existing-audio release.');

const cachedAssets = new Set([...worker.matchAll(/['"]\.\/([^'"]+)['"]/g)].map(match => match[1]));
for (const asset of ['nikigo-app.html', 'app-state.js', 'course-catalog.js', 'audio-catalog.js', 'lesson-06.html', 'lesson-06.js', 'lesson-06.css', 'lesson-07.html', 'lesson-07.js', 'lesson-07.css', 'audio/lesson-00/yo.mp3', 'audio/lesson-00/yu.mp3', 'audio/lesson-00/ha.mp3', 'audio/lesson-05/geu.mp3', 'audio/k0-consonant-contrast/ga.mp3', 'audio/k0-consonant-contrast/ka.mp3', 'audio/k0-consonant-contrast/kka.mp3', 'audio/k0-consonant-contrast/da.mp3', 'audio/k0-consonant-contrast/ta.mp3', 'audio/k0-consonant-contrast/tta.mp3', 'audio/k0-consonant-contrast/ba.mp3', 'audio/k0-consonant-contrast/pa.mp3', 'audio/k0-consonant-contrast/ppa.mp3', 'audio/k0-consonant-contrast/ja.mp3', 'audio/k0-consonant-contrast/cha.mp3', 'audio/k0-consonant-contrast/jja.mp3', 'audio/k0-consonant-contrast/sa.mp3', 'audio/k0-consonant-contrast/ssa.mp3']) {
