...
for (const asset of ['lesson-11.html', 'lesson-11.js', 'lesson-12.html', 'lesson-12.js', 'lesson-13.html', 'lesson-13.js', 'lesson-13-classic-focus.js?v=2', 'lesson-13-classic-focus.css?v=2']) {
  assert.ok(cachedAssets.has(asset), `Service Worker is missing ${asset}.`);
}
