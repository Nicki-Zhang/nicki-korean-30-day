...
assert.match(cacheName, /lesson-07/, 'Cache version must identify the Lesson 7 preview.');

const cachedAssets = new Set([...worker.matchAll(/['"]\.\/([^'"]+)['"]/g)].map(match => match[1]));
for (const asset of ['nikigo-app.html', 'app-state.js', 'course-catalog.js', 'audio-catalog.js', 'lesson-06.html', 'lesson-06.js', 'lesson-06.css', 'lesson-07.html', 'lesson-07.js', 'lesson-07.css', 'audio/lesson-00/yo.mp3', 'audio/lesson-00/yu.mp3', 'audio/k0-consonant-contrast/ga.mp3', 'audio/k0-consonant-contrast/ka.mp3', 'audio/k0-consonant-contrast/kka.mp3']) {
