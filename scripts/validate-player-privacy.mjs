...
assert.match(reviewSource, /session\[index\]\.item\.audio/);
...
assert.match(worker, /nikigo-v(?:11-player-privacy-1|12-quality-layout-1|13-lesson-05|14-lesson-06-structure)/);
