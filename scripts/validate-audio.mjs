...
if (!/CACHE\s*=\s*'nikigo-v(?:6-audio-audit-1|7-k0-roadmap-1|8-sound-objects-1|9-letter-audio-types-1|10-consonant-contrast-1|11-player-privacy-1|12-quality-layout-1|13-lesson-05|14-lesson-06-structure)'/.test(worker)) error('Service worker cache was not versioned for the audio repair.');
