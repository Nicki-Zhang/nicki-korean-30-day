(function (global) {
  ...
  const vowels = [
    ...
    vowel('ㅓ', '어', '[eo]', 'eo', 'audio/lesson-01/eo.mp3'),
    vowel('ㅕ', '여', '[yeo]', 'yeo', 'audio/lesson-03/yeo.mp3'),
    vowel('ㅗ', '오', '[o]', 'o', 'audio/lesson-01/o.mp3'),
    vowel('ㅛ', '요', '[jo]', 'yo'),
    vowel('ㅜ', '우', '[u]', 'u', 'audio/lesson-01/u.mp3'),
    vowel('ㅠ', '유', '[ju]', 'yu'),
    vowel('ㅡ', '으', '[eu]', 'eu', 'audio/lesson-02/eu.mp3'),
    vowel('ㅣ', '이', '[i]', 'i', 'audio/lesson-02/i.mp3'),
    vowel('ㅐ', '애', '[ae]', 'ae', 'audio/lesson-02/ae.mp3', 'compound-vowel'),
    vowel('ㅒ', '얘', '[yae]', 'yae', null, 'compound-vowel'),
    vowel('ㅔ', '에', '[e]', 'e', 'audio/lesson-02/e.mp3', 'compound-vowel'),
    vowel('ㅖ', '예', '[je]', 'ye', null, 'compound-vowel'),
    vowel('ㅘ', '와', '[wa]', 'wa', null, 'compound-vowel'),
    vowel('ㅙ', '왜', '[wae]', 'wae', null, 'compound-vowel'),
    vowel('ㅚ', '외', '[oe/we]', 'oe', null, 'compound-vowel'),
    vowel('ㅝ', '워', '[wo]', 'wo', null, 'compound-vowel'),
    vowel('ㅞ', '웨', '[we]', 'we', null, 'compound-vowel'),
    vowel('ㅟ', '위', '[wi]', 'wi', null, 'compound-vowel'),
    vowel('ㅢ', '의', '[ui]', 'ui', null, 'compound-vowel')
  ];
  ...
  const consonants = [
    ...
    consonant('ㄹ', 'basic-consonant', '리을', '라', '[r/l]', 'audio/lesson-02/ra.mp3'),
    ...
    consonant('ㅇ', 'basic-consonant', '이응', '아', '[silent/ng]', 'audio/lesson-03/a.mp3'),
    consonant('ㅈ', 'basic-consonant', '지읒', '자', '[j]', null, '자 / 차 / 짜'),
    consonant('ㅎ', 'basic-consonant', '히읗', '하', '[h]'),
    consonant('ㅋ', 'aspirated', '키읔', '카', '[k]', null, '가 / 카 / 까'),
    consonant('ㅌ', 'aspirated', '티읕', '타', '[t]', null, '다 / 타 / 따'),
    consonant('ㅍ', 'aspirated', '피읖', '파', '[p]', null, '바 / 파 / 빠'),
    consonant('ㅊ', 'aspirated', '치읓', '차', '[ch]', null, '자 / 차 / 짜'),
    consonant('ㄲ', 'tense', '쌍기역', '까', '[kk]', null, '가 / 카 / 까'),
    consonant('ㄸ', 'tense', '쌍디귿', '따', '[tt]', null, '다 / 타 / 따'),
    consonant('ㅃ', 'tense', '쌍비읍', '빠', '[pp]', null, '바 / 파 / 빠'),
    consonant('ㅆ', 'tense', '쌍시옷', '싸', '[ss]'),
    consonant('ㅉ', 'tense', '쌍지읒', '짜', '[jj]', null, '자 / 차 / 짜')
  ];
